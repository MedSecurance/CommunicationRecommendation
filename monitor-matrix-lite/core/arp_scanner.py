...
def start_arp_scanner():
    ...
    user_ip_range = global_state.user_ip_range
    # print(f"thred: {user_ip_range = }")
    common.log(f'[ARP Scanner] Scanning {len(user_ip_range)} IP addresses.')

    # for ip in ip_range:
    for ip in user_ip_range:
        # print(f"IP: {ip}")
