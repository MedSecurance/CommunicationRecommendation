...
public class EvaluateLorawanCommandHandler(
    ILogger<EvaluateLorawanCommandHandler> logger,
...
) : IRequestHandler<EvaluateLorawanCommand, EvaluateCommandResponse>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        var evaluatorResult = await lorawanEvaluator.Evaluate(request);
