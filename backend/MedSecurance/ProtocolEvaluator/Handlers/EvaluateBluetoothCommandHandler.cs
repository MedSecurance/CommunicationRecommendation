...
public class EvaluateBluetoothCommandHandler(
    ILogger<EvaluateBluetoothCommandHandler> logger,
...
) : IRequestHandler<EvaluateBluetoothCommand, EvaluateCommandResponse>
{
        ...
        CancellationToken cancellationToken)
    {
        logger.LogInformation(
            ...
            nameof(EvaluateBluetoothCommand),
            request
        );
        ...
        var evaluatorResult = await bluetoothEvaluator.Evaluate(request);
